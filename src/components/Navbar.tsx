    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-[#1E90FF] to-[#0066CC] shadow-lg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center gap-3 cursor-pointer" onClick={(e) => handleScroll(e as any, 'hero')}>
          ...
          <div className="flex items-center gap-8">
            <a href="#map" onClick={(e) => handleScroll(e, 'map')} className="text-white hover:text-blue-100 transition-colors text-sm font-semibold\">
              {t.navMap}
            </a>
